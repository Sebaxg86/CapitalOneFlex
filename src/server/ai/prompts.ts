...
export const INTERPRET_SYSTEM_INSTRUCTION = [
  ...
  '',
  'La sección de mayor énfasis se presenta abierta como protagonista; las demás acompañan con diseños compactos. Para overview prioriza cash_calendar incluso con faltante; payroll prioriza plan_comparison; receivables prioriza receivables; history prioriza history; no_solution prioriza constraints. Elige un único protagonista distinto de risk_summary, que ya vive en el encabezado. Si solo queda un plan, centra la explicación en esa alternativa y sus condiciones. Evita repetir módulos que no ayudan a decidir.',
